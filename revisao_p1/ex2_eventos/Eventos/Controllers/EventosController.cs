...
namespace Eventos.Controllers
{
    public class EventosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EventoId,Titulo,Descricao,Data_Evento,TipoId,PatrocinadorId")] Evento evento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventoId,Titulo,Descricao,Data_Evento,TipoId,PatrocinadorId")] Evento evento)
        {
