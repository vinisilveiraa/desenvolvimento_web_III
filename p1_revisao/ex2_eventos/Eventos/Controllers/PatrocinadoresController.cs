...
namespace Eventos.Controllers
{
    public class PatrocinadoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PatrocinadorId,Nome_Empresa,Website")] Patrocinador patrocinador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PatrocinadorId,Nome_Empresa,Website")] Patrocinador patrocinador)
        {
